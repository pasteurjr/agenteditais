# Conjunto de Dados C V8 — Sprint 8 (Dispensas, Classificacao, Mascara) / Empresa Bio-Hosp

> **V8** — Conjunto C de dados, continuidade da cadeia Bio-Hosp S1→S7 V8. Estrutura idêntica ao molde; identidade adaptada.
...
|---|---|---|---|---|---|
| 1 | 1o edital Bio-Hosp | 75-I | R$ 50.000 | **aberta** | — |
| 2 | 2o edital Bio-Hosp | 75-II | R$ 100.000 | **aberta** | — |
| 3 | 3o edital Bio-Hosp | 75-I | R$ 50.000 | **cotacao_enviada** | "Cotacao gerada via IA..." |
| 4 | 4o edital Bio-Hosp | 75-II | R$ 100.000 | **cotacao_enviada** | "Proposta enviada ao orgao..." |
| 5 | 5o edital Bio-Hosp | 75-I | R$ 45.000 | **adjudicada** | "Adjudicado." |
| 6 | 6o edital Bio-Hosp | 75-II | R$ 80.000 | **encerrada** | "Contrato firmado." |
...
|---|---|---|---|---|---|---|---|
| 1 | Monitor Multiparâmetro Nihon Kohden BSM-3000 (SKU NK-BSM3000-BR) | "[NORMALIZADO] {nome} — descricao padronizada para licitacoes publicas" | true | "{nome} tipo A", "{nome} premium" | "monitor multiparametro", "monitor de sinais vitais" | 45 | 82 |
| 2 | 2o produto Bio-Hosp | "[NORMALIZADO] {nome} — descricao padronizada para licitacoes publicas" | true | "{nome} tipo A", "{nome} premium" | "reagente", "kit diagnostico" | 45 | 82 |
