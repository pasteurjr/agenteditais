# Conjunto de Dados C V8 — Sprint 7 (Mercado / Concorrentes / Aprendizado IA) / Empresa Bio-Hosp

> **V8** — Conjunto C de dados, continuidade da cadeia Bio-Hosp S1→S6 V8. Estrutura idêntica ao molde; identidade adaptada.
...
- 20 participacoes distribuidas ciclicamente entre os 5 concorrentes e os 10 primeiros editais Bio-Hosp
...
|---|---|---|---|
| vitoria | 8 | R$ 45.000 a R$ 67.400 | Bio-Hosp |
