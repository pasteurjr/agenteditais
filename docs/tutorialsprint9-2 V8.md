# TUTORIAL DE VALIDAÇÃO MANUAL — SPRINT 9 — CONJUNTO 2 V8 (Bio-Hosp)

**Data:** 2026-05-18
**Empresa:** Bio-Hosp Equipamentos Hospitalares Ltda. (CNPJ 33.014.556/0001-96 — IE 062.118.443.0078)
**Dados de apoio:** `docs/dadossprint9-2 V8.md`
**Referencia:** `docs/CASOS DE USO SPRINT9.md`
**Pré-requisito:** `tutorialsprint8-2 V8.md`
**UCs cobertos:** 12 (LA01-LA06, SC01-SC05, HC01)
**Publico:** validador humano acompanhando roteiro passo-a-passo

> **CHANGELOG V8** — Conjunto 2 encadeado na cadeia Bio-Hosp S1→S8 V8; estrutura de UCs idêntica ao molde validado; só a identidade adaptada; reflete estado pós-correções Arnaldo + melhorias UX.
...
- Cadeia Bio-Hosp S1→S8 V8 executada (pré-requisito: `tutorialsprint8-2 V8.md`)
- Seeds executadas:
...
22. Selecionar edital + item com Camadas A-E configuradas (item do produto-chave **Monitor Multiparâmetro Nihon Kohden BSM-3000** — SKU NK-BSM3000-BR)
...
32. Clicar botao para abrir modal de configuracao:
    - Select Edital (lista editais Bio-Hosp)
