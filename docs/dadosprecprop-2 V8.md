# Conjunto de Dados 2 V8 — Precificacao e Proposta / Empresa Bio-Hosp
# Validacao Automatizada e pelo Dono do Produto

> **V8** — Conjunto C de dados, continuidade da cadeia Bio-Hosp S1->S(N-1) V8. Estrutura identica ao molde Conjunto 1; identidade adaptada (empresa/usuario/CNPJ/produtos).
...
|---|---|---|
| Email | validaarnaldo@valida.com.br | validaarnaldo@valida.com.br |
| Senha | 123456 | 123456 |
| Perfil | Superusuario | Superusuario |
| Empresa vinculada | Bio-Hosp | (associar previamente) |
| Papel | admin | admin |
...
4. Clicar em "Bio-Hosp Equipamentos Hospitalares Ltda."
5. Sistema carrega o Dashboard com a empresa selecionada

### Pre-requisitos: Dados das Sprints 1 e 2

Os dados de empresa, portfolio e parametrizacoes do `dadosempportpar-2.md` (Sprint 1) e os editais captados e validados do `dadoscapval-2.md` (Sprint 2) devem estar cadastrados antes de executar os testes da Sprint 3. Os recursos relevantes sao:

#### Produtos cadastrados (Sprint 1)

| Produto | Fabricante | SKU | NCM | Area |
|---|---|---|---|---|
| Monitor Multiparametro Nihon Kohden BSM-3000 | Nihon Kohden | NK-BSM3000-BR | 9018.19.90 | Equip. Medico-Hospitalares |
| Desfibrilador Externo Automatico Philips HeartStart FRx | Philips | PH-FRX-BR | 9018.90.99 | Equip. Medico-Hospitalares |
...
### Custos ERP — Monitor Multiparametro Nihon Kohden BSM-3000
...
### Custos ERP — Desfibrilador Externo Automatico Philips HeartStart FRx

| Campo | Valor |
|---|---|
| Produto | Desfibrilador Externo Automatico Philips HeartStart FRx |
| SKU | PH-FRX-BR |
...
#### Monitor Multiparametro Nihon Kohden BSM-3000
...
#### Desfibrilador Externo Automatico Philips HeartStart FRx
...
|---|---|---|---|
| Monitor Nihon Kohden BSM-3000 | R$ 22.486,40 | -18% | R$ 18.438,85 |
| Desfibrilador Philips HeartStart FRx | R$ 121.504,00 | -13% | R$ 105.708,48 |
...
|---|---|---|---|
| Monitor Nihon Kohden BSM-3000 | R$ 18.500,00 | R$ 17.800,00 | 3,8% |
...
|---|---|---|---|
| Monitor Nihon Kohden BSM-3000 | R$ 17.800,00 | R$ 16.500,00 | 17,5% |
...
### Sugestoes geradas pelo pipeline (Monitor Nihon Kohden BSM-3000)
...
| Responsavel pelo envio | Arnaldo Validador |
...
10. **Empresa real:** Bio-Hosp — CNPJ 33.014.556/0001-96 — Inscricao Estadual 062.118.443.0078 — ATIVA na Receita Federal.
