# TUTORIAL DE VALIDAÇÃO MANUAL — SPRINT 7 — CONJUNTO 2 V8 (Bio-Hosp)

**Data:** 2026-05-18
**Empresa:** Bio-Hosp Equipamentos Hospitalares Ltda. (CNPJ 33.014.556/0001-96 — IE 062.118.443.0078)
**Dados de apoio:** `docs/dadossprint7-2 V8.md`
**Referencia:** `docs/CASOS DE USO SPRINT7 V4.md`
**Pré-requisito:** `tutorialsprint6-2 V8.md`
**UCs cobertos:** 12 (ME01..ME04, AN01..AN05, AP01..AP03)
**Publico:** validador humano acompanhando roteiro passo-a-passo

> **CHANGELOG V8** — Conjunto 2 encadeado na cadeia Bio-Hosp S1→S6 V8; estrutura de UCs idêntica ao molde validado; só a identidade adaptada; reflete estado pós-correções Arnaldo + melhorias UX.
...
- Cadeia Bio-Hosp S1→S6 V8 executada (pré-requisito: `tutorialsprint6-2 V8.md`)
- Seeds executadas:
