# TUTORIAL DE VALIDAÇÃO MANUAL — SPRINT 5 — CONJUNTO 2 V8 (Bio-Hosp)

**Data:** 2026-05-18
**Empresa:** Bio-Hosp Equipamentos Hospitalares Ltda. (CNPJ 33.014.556/0001-96)
**Dados de apoio:** `docs/dadossprint5-2 V8.md`
...
- Sprints 1-4 previamente validadas (`tutorialsprint4-2 V8.md` concluído — cadeia Bio-Hosp S1→S4)
...
- **Pré-requisito:** seed Sprint 5 executada com sucesso + cadeia Bio-Hosp S1→S4 V8 concluída
