# Conjunto de Dados C V8 — Sprint 5 (Empenhos / Contratos a vencer / CRM) / Empresa Bio-Hosp

> **V8** — Conjunto C de dados, continuidade da cadeia Bio-Hosp S1→S4 V8. Estrutura idêntica ao molde; identidade adaptada.

**Data:** 2026-05-18
**Usuário:** validaarnaldo@valida.com.br / 123456
...
- **Produtos:** Kit Hemograma Sysmex, Monitor Multiparâmetro Nihon Kohden BSM-3000 (SKU NK-BSM3000-BR)
