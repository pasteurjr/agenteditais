# Tutorial de Validação Manual — Sprint 1 — Conjunto 3 V7
...
>
> Esta é a versão V7 do tutorial Conjunto 3 (Vita-Sense/PR). Mesmas correções aplicadas no V7-2 (Bio-Hosp/MG) — ver `docs/ANALISE OBS SPRINT1.md` e `docs/tutorialsprint1-2 V7.md` CHANGELOG V7 para a lista completa de mudanças (25 itens cobrindo 6 UCs).
>
> **Bugs corrigidos no código** (F03-01, F04-04, F04-06, F04-07, F04-08, F04-01).
> **Mudanças visíveis na UI** (F01-02, F01-04, F01-07, F01-08, F02-02, F04-02, F04-03, F04-05, F05-01, F05-02, F05-03, F13-01, F03-03).
> **Pedidos de fluxo** (F02-01 nota explicativa, F01-03 sem re-login).
>
> Para Vita-Sense (PR):
> - Lista de Fontes de Certidões agora filtra por UF=PR — você verá SEFAZ-PR, Pref. Curitiba, e fontes federais. Não verá mais SEFAZ-MG/SP.
>
