# Conjunto de Dados C V8 — Sprint 5 (Empenhos / Contratos a vencer / CRM) / Empresa Vita-Sense

> **V8** — Conjunto C de dados, continuidade da cadeia Vita-Sense S1→S4 V8. Estrutura idêntica ao molde; identidade adaptada.

**Data:** 2026-05-18
**Usuário:** validaargus@valida.com.br / 123456
...
- **Produtos:** Kit Hemograma Sysmex, Ventilador Pulmonar Dräger Savina 300 (SKU DRG-SVN300-BR)
