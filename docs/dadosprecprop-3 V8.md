# Conjunto de Dados 3 V8 — Precificacao e Proposta / Empresa Vita-Sense
# Validacao Automatizada e pelo Dono do Produto

> **V8** — Conjunto C de dados, continuidade da cadeia Vita-Sense S1->S(N-1) V8. Estrutura identica ao molde Conjunto 1; identidade adaptada (empresa/usuario/CNPJ/produtos).
...
|---|---|---|
| Email | validaargus@valida.com.br | validaargus@valida.com.br |
| Senha | 123456 | 123456 |
| Perfil | Superusuario | Superusuario |
| Empresa vinculada | Vita-Sense | (associar previamente) |
| Papel | admin | admin |
...
4. Clicar em "Vita-Sense Solucoes Medicas Ltda."
5. Sistema carrega o Dashboard com a empresa selecionada

### Pre-requisitos: Dados das Sprints 1 e 2

Os dados de empresa, portfolio e parametrizacoes do `dadosempportpar-3.md` (Sprint 1) e os editais captados e validados do `dadoscapval-3.md` (Sprint 2) devem estar cadastrados antes de executar os testes da Sprint 3. Os recursos relevantes sao:

#### Produtos cadastrados (Sprint 1)

| Produto | Fabricante | SKU | NCM | Area |
|---|---|---|---|---|
| Ventilador Pulmonar Drager Savina 300 | Drager | DRG-SVN300-BR | 9018.19.90 | Equip. Medico-Hospitalares |
| Oximetro de Pulso Portatil Mindray PM-60 | Mindray | MD-PM60-BR | 9018.19.90 | Equip. Medico-Hospitalares |
...
### Custos ERP — Ventilador Pulmonar Drager Savina 300
...
### Custos ERP — Oximetro de Pulso Portatil Mindray PM-60

| Campo | Valor |
|---|---|
| Produto | Oximetro de Pulso Portatil Mindray PM-60 |
| SKU | MD-PM60-BR |
...
#### Ventilador Pulmonar Drager Savina 300
...
#### Oximetro de Pulso Portatil Mindray PM-60
...
|---|---|---|---|
| Ventilador Drager Savina 300 | R$ 22.486,40 | -18% | R$ 18.438,85 |
| Oximetro Mindray PM-60 | R$ 121.504,00 | -13% | R$ 105.708,48 |
...
|---|---|---|---|
| Ventilador Drager Savina 300 | R$ 18.500,00 | R$ 17.800,00 | 3,8% |
...
|---|---|---|---|
| Ventilador Drager Savina 300 | R$ 17.800,00 | R$ 16.500,00 | 17,5% |
...
### Sugestoes geradas pelo pipeline (Ventilador Drager Savina 300)
...
| Estilo | Tecnico |
| Produto | Ventilador Pulmonar Drager Savina 300 |
| Descricao | "Ventilador pulmonar para UTI e pronto-socorro, 10 parametros monitorados, tela touch TFT colorida de 12,1 polegadas, ventilacao invasiva e nao invasiva, monitoracao continua de ECG (12 derivacoes), SpO2, NIBP, temperatura, frequencia respiratoria e EtCO2. Bateria com autonomia de 6 horas. Peso de 4,1 kg. Alimentacao 100-240 VAC. Registro ANVISA 80262090001." |
...
| Responsavel pelo envio | Argus Validador |
...
10. **Empresa real:** Vita-Sense — CNPJ 49.825.713/0001-04 — Inscricao Estadual 901.234.567.0098 — ATIVA na Receita Federal.
