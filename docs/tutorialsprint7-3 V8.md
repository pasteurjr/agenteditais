# TUTORIAL DE VALIDAÇÃO MANUAL — SPRINT 7 — CONJUNTO 3 V8 (Vita-Sense)

**Data:** 2026-05-18
**Empresa:** Vita-Sense Soluções Médicas Ltda. (CNPJ 49.825.713/0001-04 — IE 901.234.567.0098)
**Dados de apoio:** `docs/dadossprint7-3 V8.md`
**Referencia:** `docs/CASOS DE USO SPRINT7 V4.md`
**Pré-requisito:** `tutorialsprint6-3 V8.md`
**UCs cobertos:** 12 (ME01..ME04, AN01..AN05, AP01..AP03)
**Publico:** validador humano acompanhando roteiro passo-a-passo

> **CHANGELOG V8** — Conjunto 3 encadeado na cadeia Vita-Sense S1→S6 V8; estrutura de UCs idêntica ao molde validado; só a identidade adaptada; reflete estado pós-correções Arnaldo + melhorias UX.
...
- Cadeia Vita-Sense S1→S6 V8 executada (pré-requisito: `tutorialsprint6-3 V8.md`)
- Seeds executadas:
