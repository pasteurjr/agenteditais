# TUTORIAL DE VALIDAÇÃO MANUAL — SPRINT 6 — CONJUNTO 3 V8 (Vita-Sense)

**Data:** 2026-05-18
**Empresa:** Vita-Sense Soluções Médicas Ltda. (CNPJ 49.825.713/0001-04)
**Dados de apoio:** `docs/dadossprint6-3 V8.md`
...
- Cadeia Vita-Sense S1→S4 V8 concluída (`tutorialsprint4-3 V8.md`)
...
3. Preencher: termo = "ventilador pulmonar", frequencia = 8h
4. Clicar Salvar
...
- **Pré-requisito:** seeds Sprint 5 + Sprint 6 executadas + cadeia Vita-Sense S1→S4 V8 concluída
