# CASOS DE USO — RECURSOS E IMPUGNACOES

**Data:** 27/03/2026
**Versao:** 1.0
**Base:** requisitos_completosv6.md (RF-042 a RF-044) + SPRINT RECURSOS E IMPUGNACOES - V02.docx
**Objetivo:** Definir detalhadamente a interacao do usuario com a interface, incluindo telas, campos, botoes, pre/pos condicoes e sequencia de eventos para os modulos de Disputas, Impugnacao/Esclarecimentos e Recursos/Contra-Razoes.

---

## INDICE

### FASE 1 — DISPUTAS (Lances)
- [UC-D01] Sala de Lances (Lance Aberto)
- [UC-D02] Sala de Lances (Lance Aberto + Fechado)

### FASE 2 — IMPUGNACAO E ESCLARECIMENTOS
...
### FASE 3 — RECURSOS E CONTRA-RAZOES
...
**RF relacionado:** RF-042-01
**Ator:** Usuario (Analista Comercial)

### Pre-condicoes
1. Usuario esta autenticado no sistema
2. Edital foi salvo e precificado (camadas A-E definidas)
3. Estrategia competitiva definida (UC-P08 do sprint anterior)
4. Sessao de disputa do tipo "Lance Aberto" identificada no edital
5. Valor Inicial (Camada D) e Valor Minimo (Camada E) configurados

### Pos-condicoes
1. Lances registrados com timestamp e valor
2. Historico de lances salvo no banco
3. Resultado da disputa registrado (ganhou/perdeu/reposicionou)
4. LOG imutavel de todos os lances enviados

### Layout da Tela — DisputaPage > Aba "Lance Aberto"

```
┌─────────────────────────────────────────────────────────────────────┐
│ SALA DE LANCES                                                       │
│ Disputa em tempo real — Lance Aberto                                │
│                                                                      │
│ [Aba: Lance Aberto ●] [Aba: Lance Aberto+Fechado]                  │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
│ ┌─ CARD: Identificacao da Disputa ─────────────────────────────────┐│
│ │ Edital: PE 46/2026 — Fiocruz                                     ││
│ │ Lote: 01 — Hematologia                                           ││
│ │ Modalidade: [Badge: LANCE ABERTO]                                 ││
│ │ Tempo para contra-lance: [Badge: ⏱ 02:00 min]                   ││
│ └───────────────────────────────────────────────────────────────────┘│
│                                                                      │
│ ┌─ CARD: Painel de Lances ─────────────────────────────────────────┐│
│ │                                                                   ││
│ │ ── Seus Limites ──                                               ││
│ │ Valor Inicial (D): R$ 145,00                                     ││
│ │ Valor Minimo (E):  R$ 95,00  [Badge: ⛔ Piso de seguranca]      ││
│ │ Custo Base (A):    R$ 85,00                                      ││
│ │                                                                   ││
│ │ ── Lance Atual ──                                                ││
│ │ Melhor lance do pregao: R$ 138,00 (Empresa ABC)                  ││
│ │ Seu ultimo lance:       R$ 140,00 [Badge: 2o lugar]              ││
│ │                                                                   ││
│ │ [NumberInput: Novo Lance]  [R$ ___,__]                           ││
│ │ [Badge: Margem sobre custo: XX,X%]                               ││
│ │                                                                   ││
│ │ [ActionButton: Enviar Lance]                                     ││
│ │                                                                   ││
│ │ ⚠ Sistema bloqueia lances abaixo de R$ 95,00 (Valor Minimo E)   ││
│ └───────────────────────────────────────────────────────────────────┘│
│                                                                      │
│ ┌─ CARD: Historico de Lances ──────────────────────────────────────┐│
│ │ ┌──────┬──────────────┬──────────┬──────────┬──────────┐         ││
│ │ │ #    │ Hora         │ Empresa  │ Valor    │ Posicao  │         ││
│ │ ├──────┼──────────────┼──────────┼──────────┼──────────┤         ││
│ │ │ 5    │ 10:15:32     │ Voce     │ R$140,00 │ 2o       │         ││
│ │ │ 4    │ 10:14:58     │ Emp. ABC │ R$138,00 │ 1o       │         ││
│ │ │ 3    │ 10:13:10     │ Voce     │ R$142,00 │ 1o       │         ││
│ │ │ 2    │ 10:12:45     │ Emp. XYZ │ R$143,00 │ 2o       │         ││
│ │ │ 1    │ 10:10:00     │ Voce     │ R$145,00 │ 1o       │         ││
│ │ └──────┴──────────────┴──────────┴──────────┴──────────┘         ││
│ └───────────────────────────────────────────────────────────────────┘│
│                                                                      │
│ ┌─ CARD: Status da Disputa ────────────────────────────────────────┐│
│ │ [Badge: 🟢 EM ANDAMENTO] Tempo restante: 02:00                  ││
│ │                                                                   ││
│ │ Regra: 2 minutos para contra-lance apos cada novo lance.         ││
│ │ Se nenhum lance em 2 min, sessao encerra automaticamente.        ││
│ │                                                                   ││
│ │ [Badge: ⏱ Ultimo lance ha: 01:15]                               ││
│ └───────────────────────────────────────────────────────────────────┘│
└─────────────────────────────────────────────────────────────────────┘
```
...
|----|----------|------|-------------|-----------|
| D01-F01 | Edital | Display readonly | — | Identificacao do edital em disputa |
| D01-F02 | Lote | Display readonly | — | Lote em disputa |
| D01-F03 | Badge Modalidade | Badge | — | Indica tipo "LANCE ABERTO" |
| D01-F04 | Timer Contra-Lance | Badge timer | — | Contagem regressiva de 2 minutos |
| D01-F05 | Valor Inicial (D) | Display readonly | — | Valor inicial configurado na precificacao |
| D01-F06 | Valor Minimo (E) | Display readonly | — | Piso de seguranca — lances abaixo sao bloqueados |
| D01-F07 | Custo Base (A) | Display readonly | — | Custo base para referencia de margem |
| D01-F08 | Melhor Lance Pregao | Display destaque | — | Melhor lance atual com nome da empresa |
| D01-F09 | Seu Ultimo Lance | Display + Badge | — | Ultimo lance enviado com posicao |
| D01-F10 | Novo Lance | NumberInput | Sim | Valor do novo lance a enviar |
| D01-F11 | Badge Margem | Badge calculado | — | Margem sobre custo: (Lance - Custo) / Custo × 100 |
| D01-F12 | Botao Enviar Lance | ActionButton primary | — | Envia lance ao sistema. Bloqueado se valor < Minimo (E) |
| D01-F13 | Tabela Historico | DataTable | — | Colunas: #, Hora, Empresa, Valor, Posicao |
| D01-F14 | Badge Status Disputa | Badge colorido | — | Verde=em andamento, Vermelho=encerrada |
| D01-F15 | Timer Ultimo Lance | Display | — | Tempo desde o ultimo lance no pregao |

### Sequencia de Eventos

1. Usuario acessa **DisputaPage** e clica na aba **"Lance Aberto"**
2. Sistema exibe **[D01-F01]** e **[D01-F02]** com dados do edital/lote em disputa
3. **[D01-F03]** indica modalidade "LANCE ABERTO"
4. Sistema carrega limites do usuario: **[D01-F05]** Valor Inicial, **[D01-F06]** Valor Minimo, **[D01-F07]** Custo Base
5. **[D01-F08]** mostra o melhor lance atual do pregao (dados do portal ou simulacao)
6. **[D01-F09]** mostra o ultimo lance do usuario com posicao
7. Usuario digita novo valor em **[D01-F10]** — **[D01-F11]** recalcula margem em tempo real
8. **Validacao:** se valor < **[D01-F06]** Valor Minimo, sistema BLOQUEIA **[D01-F12]** e exibe alerta
9. **Validacao:** se valor >= lance anterior do usuario, sistema exibe erro "Lance deve ser menor"
10. Usuario clica **[D01-F12] Enviar Lance** — lance registrado com timestamp
11. **[D01-F13]** atualiza com o novo lance
12. **[D01-F04]** reinicia contagem de 2 minutos para contra-lance
13. Se nenhum novo lance em 2 minutos, **[D01-F14]** muda para "ENCERRADA"
14. Sistema registra resultado final: posicao, valor, margem obtida
...
**RF relacionado:** RF-042-02
**Ator:** Usuario (Analista Comercial)

### Pre-condicoes
1. Usuario esta autenticado no sistema
2. Edital foi salvo e precificado (camadas A-E definidas)
3. Estrategia competitiva definida
4. Sessao de disputa do tipo "Lance Aberto + Fechado" identificada no edital
5. Valor Inicial (Camada D) e Valor Minimo (Camada E) configurados

### Pos-condicoes
1. Lances abertos registrados com historico completo
2. Lance fechado registrado (sem visibilidade para concorrentes)
3. Resultado consolidado apos abertura dos lances fechados
4. LOG imutavel de toda a sequencia (aberto + fechado)

### Layout da Tela — DisputaPage > Aba "Lance Aberto + Fechado"

```
┌─────────────────────────────────────────────────────────────────────┐
│ SALA DE LANCES                                                       │
│ Disputa em tempo real — Lance Aberto + Fechado                      │
│                                                                      │
│ [Aba: Lance Aberto] [Aba: Lance Aberto+Fechado ●]                  │
├─────────────────────────────────────────────────────────────────────┤
│                                                                      │
...
│ │ Edital: PE 46/2026 — Fiocruz                                     ││
│ │ Lote: 01 — Hematologia                                           ││
│ │ Modalidade: [Badge: ABERTO + FECHADO]                             ││
│ │ Fase Atual: [Badge: 🟢 FASE ABERTA] ou [Badge: 🔒 FASE FECHADA]││
│ └───────────────────────────────────────────────────────────────────┘│
│                                                                      │
│ ┌─ CARD: Fase 1 — Lance Aberto ───────────────────────────────────┐│
│ │ (Identico ao UC-D01 enquanto fase aberta esta ativa)             ││
│ │                                                                   ││
│ │ Melhor lance aberto: R$ 130,00 (Empresa ABC)                    ││
│ │ Seu melhor lance:    R$ 132,00 [Badge: 2o lugar]                ││
│ │                                                                   ││
│ │ [Badge: ✅ FASE ABERTA ENCERRADA — Resultado parcial salvo]     ││
│ └───────────────────────────────────────────────────────────────────┘│
│                                                                      │
│ ┌─ CARD: Fase 2 — Lance Fechado (5 min) ──────────────────────────┐│
│ │ [Badge: 🔒 LANCE SEM VISIBILIDADE]                              ││
│ │                                                                   ││
│ │ Tempo restante: [Badge: ⏱ 05:00 min]                            ││
│ │                                                                   ││
│ │ Voce NAO ve os lances dos concorrentes nesta fase.               ││
│ │ Defina seu lance final estrategico.                              ││
│ │                                                                   ││
│ │ Referencia (seu melhor lance aberto): R$ 132,00                  ││
│ │ Valor Minimo (E):                     R$ 95,00                   ││
│ │                                                                   ││
│ │ [NumberInput: Lance Fechado]  [R$ ___,__]                        ││
│ │ [Badge: Margem sobre custo: XX,X%]                               ││
│ │                                                                   ││
│ │ ── Sugestao IA ──                                                ││
│ │ [Badge: 💡 IA sugere: R$ 125,00 (margem 47% sobre custo)]      ││
│ │ Baseado em: historico de disputas similares + estrategia          ││
│ │                                                                   ││
│ │ [ActionButton: Enviar Lance Fechado]                             ││
│ │                                                                   ││
│ │ ⚠ Apos enviar, NAO e possivel alterar.                          ││
│ └───────────────────────────────────────────────────────────────────┘│
│                                                                      │
│ ┌─ CARD: Resultado Final (apos abertura dos fechados) ─────────────┐│
│ │ [Badge: 🏆 RESULTADO CONSOLIDADO]                                ││
│ │                                                                   ││
│ │ ┌──────┬──────────────┬──────────────┬──────────────┬──────────┐ ││
│ │ │ Pos. │ Empresa      │ Lance Aberto │ Lance Fechado│ Final    │ ││
│ │ ├──────┼──────────────┼──────────────┼──────────────┼──────────┤ ││
│ │ │ 1o   │ Voce         │ R$ 132,00    │ R$ 125,00    │ R$125,00│ ││
│ │ │ 2o   │ Empresa ABC  │ R$ 130,00    │ R$ 128,00    │ R$128,00│ ││
│ │ │ 3o   │ Empresa XYZ  │ R$ 135,00    │ R$ 133,00    │ R$133,00│ ││
│ │ └──────┴──────────────┴──────────────┴──────────────┴──────────┘ ││
│ │                                                                   ││
│ │ [Badge: 🏆 Voce venceu! Lance final: R$ 125,00 — Margem: 47%]  ││
│ └───────────────────────────────────────────────────────────────────┘│
└─────────────────────────────────────────────────────────────────────┘
```
...
| ID | Elemento | Tipo | Obrigatorio | Descricao |
|----|----------|------|-------------|-----------|
| D02-F01 | Edital | Display readonly | — | Identificacao do edital em disputa |
| D02-F02 | Lote | Display readonly | — | Lote em disputa |
| D02-F03 | Badge Modalidade | Badge | — | Indica tipo "ABERTO + FECHADO" |
| D02-F04 | Badge Fase Atual | Badge colorido | — | Verde=Fase Aberta, Cadeado=Fase Fechada |
| D02-F05 | Card Fase Aberta | Card | — | Painel identico ao UC-D01 para fase aberta |
| D02-F06 | Badge Fase Encerrada | Badge | — | Indica que fase aberta encerrou |
| D02-F07 | Timer Fase Fechada | Badge timer | — | Contagem regressiva de 5 minutos |
| D02-F08 | Referencia Lance Aberto | Display readonly | — | Melhor lance do usuario na fase aberta |
| D02-F09 | Valor Minimo (E) | Display readonly | — | Piso de seguranca |
| D02-F10 | Lance Fechado | NumberInput | Sim | Valor do lance fechado (sem visibilidade) |
| D02-F11 | Badge Margem | Badge calculado | — | Margem sobre custo: (Lance - Custo) / Custo × 100 |
| D02-F12 | Sugestao IA | Badge + Display | — | Valor sugerido pela IA com fundamentacao |
| D02-F13 | Botao Enviar Lance Fechado | ActionButton primary | — | Envia lance fechado. Irrevogavel apos envio |
| D02-F14 | Tabela Resultado Final | DataTable | — | Colunas: Posicao, Empresa, Lance Aberto, Lance Fechado, Final |
| D02-F15 | Badge Resultado | Badge destaque | — | Resultado: vitoria/derrota com margem final |

### Sequencia de Eventos

1. Usuario acessa **DisputaPage** e clica na aba **"Lance Aberto + Fechado"**
2. Sistema exibe **[D02-F01]** e **[D02-F02]** com dados do edital/lote
3. **[D02-F04]** indica fase atual: "FASE ABERTA"
4. **FASE ABERTA:** Funciona identico ao UC-D01 — usuario envia lances com visibilidade total
5. Apos 2 minutos sem novos lances, fase aberta encerra — **[D02-F06]** exibe badge de encerramento
6. **[D02-F04]** muda para "FASE FECHADA" — **[D02-F07]** inicia contagem de 5 minutos
7. **[D02-F08]** mostra o melhor lance do usuario na fase aberta como referencia
8. Usuario nao ve lances dos concorrentes nesta fase
9. IA exibe sugestao em **[D02-F12]** baseada em historico + estrategia definida
10. Usuario digita valor em **[D02-F10]** — **[D02-F11]** calcula margem em tempo real
11. **Validacao:** se valor < **[D02-F09]** Valor Minimo, sistema BLOQUEIA envio
12. Usuario clica **[D02-F13] Enviar Lance Fechado** — confirmacao obrigatoria (irrevogavel)
13. Apos 5 minutos, sistema abre os lances fechados de todos os concorrentes
14. **[D02-F14]** exibe tabela com resultado consolidado (aberto + fechado + final)
15. **[D02-F15]** exibe resultado: vitoria ou derrota com margem final sobre custo
