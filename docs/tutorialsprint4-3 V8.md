# Tutorial de Validação Manual — Sprint 4 — Conjunto 3 V8
# Empresa: Vita-Sense Solucoes Medicas Ltda.

**Data:** 18/05/2026 (V8)
**Dados:** dadosrecursimp-3 V8.md (continuidade do tutorialsprint2-3 V8.md)
...
**Pre-condicoes:**
- Usuario autenticado no sistema (validaargus@valida.com.br, empresa: Vita-Sense)
...
await expect(page.locator('text=Vita-Sense')).toBeVisible();
await expect(page.locator('text=49.825.713/0001-04')).toBeVisible();
...
| Impugnante | Vita-Sense Solucoes Medicas Ltda. |
| CNPJ Impugnante | 49.825.713/0001-04 |
...
| 4 | Verificar qualificacao | `text=Vita-Sense` | — | Razao social no texto |
| 5 | Verificar CNPJ | `text=49.825.713/0001-04` | — | CNPJ presente |
...
**Pagina:** `ImpugnacaoPage` — rota `/app/impugnacao` (aba Peticoes)
**Pre-condicoes:**
- Usuario autenticado (validaargus@valida.com.br, empresa: Vita-Sense)
...
| Recorrente | Vita-Sense Solucoes Medicas Ltda. |
| CNPJ Recorrente | 49.825.713/0001-04 |
| Representante Legal | Diego Ricardo Munoz — Socio-Administrador |
...
| 3 | Verificar cabecalho | `text=PREGOEIRO` ou `text=COMISSAO` | — | Cabecalho presente |
| 4 | Verificar recorrente | `text=Vita-Sense` | — | Razao social no texto |
| 5 | Verificar CNPJ | `text=49.825.713/0001-04` | — | CNPJ presente |
| 6 | Verificar representante | `text=Diego Ricardo Munoz` | — | Nome presente |
| 7 | Verificar secao Dos Fatos | `text=Dos Fatos` | — | Secao presente |
...
**Pre-condicoes:**
- Usuario autenticado (validaargus@valida.com.br, empresa: Vita-Sense)
- Edital de "oximetro de pulso portatil" (segundo edital) selecionado
- Cenario: Vita-Sense e a vencedora e precisa se defender de recurso
...
// Selecionar edital de "oximetro de pulso portatil"
await page.click('select, [role="combobox"]');
await page.click('text=oximetro de pulso portatil');
...
| Campo | Valor |
|---|---|
| Edital | Edital de "oximetro de pulso portatil" (segundo edital salvo) |
| Tipo de Laudo | Contra-Razao de Recurso |
| Contra-Arrazoante | Vita-Sense Solucoes Medicas Ltda. |
| CNPJ | 49.825.713/0001-04 |
| Recorrente (adversario) | BioEquip Distribuidora de Equipamentos Medicos S.A. |
| Motivo do Recurso do Adversario | Alega que preco da Vita-Sense e inexequivel |
...
| 4 | Fabricante Drager fornece nota de credito por volume que justifica desconto | Documentacao comprobatoria do fabricante |
...
| Do Pedido | Manutencao da adjudicacao em favor da Vita-Sense |
| Fechamento | Local, data, assinatura |
...
|---|------|----------|------|--------|
| 1 | Clicar em Recursos na sidebar | `button:has-text("Recursos")` | — | URL contem `/app/recursos` |
| 2 | Selecionar edital | `select, [role="combobox"]` | Edital "oximetro de pulso portatil" | Edital selecionado |
...
| 6 | Verificar contra-arrazoante | `text=Vita-Sense` | — | Razao social presente |
| 7 | Verificar CNPJ | `text=49.825.713/0001-04` | — | CNPJ presente |
...
**Pre-condicoes:**
- Usuario autenticado (validaargus@valida.com.br, empresa: Vita-Sense)
- Editais de "monitor multiparametrico" e "oximetro de pulso portatil" com propostas finalizadas
...
| Campo | Valor |
|---|---|
| Edital | Edital de "oximetro de pulso portatil" (segundo edital) |
| Resultado | Perdido |
...
| 10 | Selecionar edital ultrassom | `select, [role="combobox"]` | Edital "oximetro de pulso portatil" | Edital selecionado |
...
> **Nota para execucao manual:** Registrar resultado "Ganho" para o edital de monitor multiparametrico e "Perdido" para o de oximetro de pulso portatil. Verificar que os badges aparecem nas linhas correspondentes.
...
| Canal | Ativo |
|---|---|
| Email (licitacoes@vitasense.com.br) | Sim |
...
- Usuario: `validaargus@valida.com.br` / Senha: `123456`
- Perfil: Superusuario
- Empresa: Vita-Sense Solucoes Medicas Ltda.
