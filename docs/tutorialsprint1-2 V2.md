...
>
> **Por que:** cada empresa tem sua própria hierarquia (`empresa_scoped=True` no banco). A empresa RP3X (que você acabou de criar/vincular) ainda não tem nenhuma área/classe/subclasse cadastrada — você precisa criar a estrutura para que os outros UCs (UC-F02 área padrão, UC-F06 filtros de produto, UC-F08 cadastro de produto, e Sprint 2 com filtros de edital) funcionem.
...
- Você deve ter logado como super (valida2 ou similar) e ter a empresa RP3X **selecionada como ativa** (UC-F18 já feito).
...
2. Diagnóstico in Vitro e Laboratório
...
#### Passo 1.3 — Criar Área "Diagnóstico in Vitro e Laboratório"

**O que fazer:** Clique `Novo` novamente. Nome: `Diagnóstico in Vitro e Laboratório`. Salvar.
...
#### Passo 2.3 — Criar Classe "Reagentes Bioquímicos" vinculada à Área "Diagnóstico in Vitro e Laboratório"

**O que fazer:** Clique `Novo`. Área: `Diagnóstico in Vitro e Laboratório`. Nome: `Reagentes Bioquímicos`. Salvar.

#### Passo 2.4 — Criar Classe "Reagentes e Kits Diagnósticos" vinculada à mesma área

**O que fazer:** Clique `Novo`. Área: `Diagnóstico in Vitro e Laboratório`. Nome: `Reagentes e Kits Diagnósticos`. Salvar.
...
#### Passo 3.3 — Criar Subclasse "Reagente para Glicose"

**O que fazer:**
1. Clique `Novo`.
2. Classe: `Reagentes Bioquímicos`
3. Nome: `Reagente para Glicose`
4. NCM: `3822.19.90`
5. Salvar.

#### Passo 3.4 — Criar Subclasse "Kit de Hematologia"

**O que fazer:**
1. Clique `Novo`.
2. Classe: `Reagentes e Kits Diagnósticos`
3. Nome: `Kit de Hematologia`
4. NCM: `3822.19.90`
5. Salvar.
...
✅ **Correto se:** Aparecem as áreas `Equipamentos Médico-Hospitalares` e `Diagnóstico in Vitro e Laboratório`.
...
- `Diagnóstico in Vitro e Laboratório`
  - `Reagentes Bioquímicos` → `Reagente para Glicose` (NCM 3822.19.90)
  - `Reagentes e Kits Diagnósticos` → `Kit de Hematologia` (NCM 3822.19.90)
...
- 3 classes criadas (Monitoração + Reagentes Bioquímicos + Reagentes e Kits Diagnósticos)
