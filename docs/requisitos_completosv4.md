# Documento de Requisitos Completos v4 — facilicita.ia

**Versao:** 4.0
**Data:** 2026-03-05
**Base:** requisitos_completosv2.md (v2.0, 2026-02-22) + REQUISITOS REVISADOS SPRINT3 0503.md
**Revisao:** Expansao de RF-039/RF-040/RF-041 (Sprint 3 — Precificacao e Proposta) com 20 requisitos detalhados extraidos dos PDFs e Blueprint Visual JPEG
...
**NOTA:** Os requisitos RF-039, RF-040 e RF-041 da v2 eram basicos (15 linhas cada). Nesta v4, eles sao substituidos por **20 requisitos detalhados** extraidos das fontes da Sprint 3.
...
- ✅ JA IMPLEMENTADO — Ja existe nas Sprints anteriores (1 ou 2)
...
### RF-039-05: Campos Adicionais no Portfolio | PRECIFICACAO (Portfolio)

| Campo | Valor |
|-------|-------|
| **Modulo** | PRECIFICACAO / PORTFOLIO |
| **Fonte** | [PDF-REVISADA] Secao Portfolio + [JPEG-2] Secao 2.1 (Inputs do Item) |
| **Status** | ⚙️ PARCIAL — CRUD do portfolio ja existe (Sprint 2), campos novos a adicionar |

**Descricao:**
Campos ja existentes: nome, NCM, categoria, fabricante, modelo, preco_referencia, specs, documentos. Campos novos a adicionar para suportar precificacao:
- Tipo de amostra
...
**Diagrama JPEG-2 (Secao 2.1):** Lista de inputs a esquerda: Tipo de amostra, Volumetria, Registro ANVISA, Modelo/Marca, NCM.

**Criterios de aceite:**
1. Novos campos no formulario de produto
2. Campos opcionais (nao bloqueiam cadastro existente)
3. Upload de fotos com preview
4. Campo URL do registro ANVISA com link clicavel

---

### RF-039-06: Atualizacao Automatica do Portfolio via Fabricante | PRECIFICACAO (Portfolio)
...
### RF-039-07: Selecao Inteligente — Agente Assistido | PRECIFICACAO
...
### RF-039-08: Input de Preco Base — Camada B | PRECIFICACAO
...
| **Status** | ⚙️ PARCIAL — tool_historico_precos + tabela precos_historicos ja existem (Sprint 2) |
...
### RF-039-13: Comodato | PRECIFICACAO
...
## ============================================================
## FIM DA SPRINT 3 — Resumo dos 20 Requisitos
## ============================================================
...
|----|-----------|-------|--------|-----------------|
| RF-039-01 | Organizacao por Lotes | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-2 + PDF-REVISADA |
| RF-039-02 | Calculo Volumetria | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-2 + PDF-REVISADA |
| RF-039-03 | Integracao ERP | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-3 + PDF-REVISADA + PDF-REUNIAO |
| RF-039-04 | Regras Tributarias NCM | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-3 + PDF-REVISADA + PDF-REUNIAO |
| RF-039-05 | Campos Portfolio | PRECIFICACAO | ⚙️ PARCIAL | JPEG-2 + PDF-REVISADA |
| RF-039-06 | Sync Fabricante | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-2 + PDF-REVISADA + PDF-REUNIAO |
| RF-039-07 | Agente Match Assistido | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-2 + PDF-REVISADA |
| RF-039-08 | Preco Base (Camada B) | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-3 + PDF-REVISADA |
| RF-039-09 | Valor Referencia (Camada C) | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-3 + PDF-REVISADA |
| RF-039-10 | Lances D e E | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-3 + PDF-REVISADA |
| RF-039-11 | Estrategia Competitiva | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-3 + PDF-REVISADA + PDF-REUNIAO |
| RF-039-12 | Historico Visual (Camada F) | PRECIFICACAO | ⚙️ PARCIAL | JPEG-4 + PDF-REVISADA |
| RF-039-13 | Comodato | PRECIFICACAO | ❌ NAO IMPLEMENTADO | JPEG-4 + PDF-REVISADA + PDF-REUNIAO |
...
**Totais Sprint 3:** 14 NAO IMPLEMENTADOS + 6 PARCIAIS (base existe, expansao nova)
**Blocos:** 13 PRECIFICACAO + 5 PROPOSTA + 2 SUBMISSAO/TRANSVERSAL
...
| — | **Sprint 3: Precificacao** | RF-039-01 a RF-039-13 |
...
| **Fluxo Comercial — Sprint 3 Precificacao** | **13 (RF-039-01 a RF-039-13)** |
...
| **Total RF** | **77** (60 da v2 - 3 substituidos + 20 novos Sprint 3) |
| **Total RNF** | **4** |
...
*Documento gerado em 2026-03-05. Fontes: requisitos_completosv2.md + REQUISITOS REVISADOS SPRINT3 0503.md + TRANSCRICAOJPEG.md + PDFs Sprint 3.*
