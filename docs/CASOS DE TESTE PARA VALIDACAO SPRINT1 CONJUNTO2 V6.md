# CASOS DE TESTE PARA VALIDACAO — Sprint 1 — Conjunto 2 — **V6**

**Data:** 2026-04-27
**Versao:** 6.0
**Empresa:** RP3X Comercio e Representacoes Ltda.
**Usuario padrao:** valida2@valida.com.br / 123456 (super, com empresa RP3X ja vinculada)
**Usuario alternativo (FA-07):** valida<N>@valida.com.br (super, SEM vinculos em `usuario_empresa`)
**Referencia:** tutorialsprint1-2.md, **CASOS DE USO EMPRESA PORTFOLIO PARAMETRIZACAO V6.md**, correcaaval1.md
**Total de UCs:** 17 (UC-F01 a UC-F17)

**Novidade V6 (27/04/2026):** Para os casos de teste do FA-07 (Super sem empresa vinculada), ver `CASOS DE TESTE PARA VALIDACAO SPRINT1 CONJUNTO1 V6.md` (CT-F01-FA07-A a CT-F01-FA07-E). Conjunto 2 mantem o foco em fluxos com `valida2` ja vinculado a RP3X — nao replica os casos do FA-07 para evitar redundancia.

**Pre-condicao alternativa para qualquer UC desta sprint:** Se usuario logado nao tem vinculos em `usuario_empresa`, o sistema exibe `[Página: "Sem Empresa Vinculada"]` antes do fluxo principal. Ver UC-F01 FA-07 na V6 do doc de UC.
