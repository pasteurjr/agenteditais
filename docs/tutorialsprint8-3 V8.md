# TUTORIAL DE VALIDAÇÃO MANUAL — SPRINT 8 — CONJUNTO 3 V8 (Vita-Sense)

**Data:** 2026-05-18
**Empresa:** Vita-Sense Soluções Médicas Ltda. (CNPJ 49.825.713/0001-04 — IE 901.234.567.0098)
**Dados de apoio:** `docs/dadossprint8-3 V8.md`
**Referencia:** `docs/CASOS DE USO SPRINT8.md`
**Pré-requisito:** `tutorialsprint7-3 V8.md`
**UCs cobertos:** 5 (DI01, CL01, CL02, CL03, MA01)
**Publico:** validador humano acompanhando roteiro passo-a-passo

> **CHANGELOG V8** — Conjunto 3 encadeado na cadeia Vita-Sense S1→S7 V8; estrutura de UCs idêntica ao molde validado; só a identidade adaptada; reflete estado pós-correções Arnaldo + melhorias UX.
...
- Cadeia Vita-Sense S1→S7 V8 executada (pré-requisito: `tutorialsprint7-3 V8.md`)
- Seeds executadas:
...
8. Selecionar 2-3 produtos via checkbox (incluir o produto-chave **Ventilador Pulmonar Dräger Savina 300** — SKU DRG-SVN300-BR)
...
2. Localizar um produto com subclasse vinculada (para ter campos_mascara) — usar o produto-chave **Ventilador Pulmonar Dräger Savina 300** (SKU DRG-SVN300-BR)
