# TUTORIAL DE VALIDAÇÃO MANUAL — SPRINT 8 — CONJUNTO 2 V8 (Bio-Hosp)

**Data:** 2026-05-18
**Empresa:** Bio-Hosp Equipamentos Hospitalares Ltda. (CNPJ 33.014.556/0001-96 — IE 062.118.443.0078)
**Dados de apoio:** `docs/dadossprint8-2 V8.md`
**Referencia:** `docs/CASOS DE USO SPRINT8.md`
**Pré-requisito:** `tutorialsprint7-2 V8.md`
**UCs cobertos:** 5 (DI01, CL01, CL02, CL03, MA01)
**Publico:** validador humano acompanhando roteiro passo-a-passo

> **CHANGELOG V8** — Conjunto 2 encadeado na cadeia Bio-Hosp S1→S7 V8; estrutura de UCs idêntica ao molde validado; só a identidade adaptada; reflete estado pós-correções Arnaldo + melhorias UX.
...
3. Na tela de selecao, clicar em **Bio-Hosp Equipamentos Hospitalares Ltda.**
...
- Cadeia Bio-Hosp S1→S7 V8 executada (pré-requisito: `tutorialsprint7-2 V8.md`)
- Seeds executadas:
...
8. Selecionar 2-3 produtos via checkbox (incluir o produto-chave **Monitor Multiparâmetro Nihon Kohden BSM-3000** — SKU NK-BSM3000-BR)
...
2. Localizar um produto com subclasse vinculada (para ter campos_mascara) — usar o produto-chave **Monitor Multiparâmetro Nihon Kohden BSM-3000** (SKU NK-BSM3000-BR)
