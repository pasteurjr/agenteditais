# TUTORIAL DE VALIDAÇÃO MANUAL — SPRINT 5 — CONJUNTO 3 V8 (Vita-Sense)

**Data:** 2026-05-18
**Empresa:** Vita-Sense Soluções Médicas Ltda. (CNPJ 49.825.713/0001-04)
**Dados de apoio:** `docs/dadossprint5-3 V8.md`
...
**Pré-requisito:** `tutorialsprint4-3 V8.md` executado com sucesso (continuidade da cadeia Vita-Sense S1→S4)

> **CHANGELOG V8** — Conjunto 3 encadeado com a cadeia Vita-Sense S1→S4 V8; estrutura de UCs idêntica ao molde validado; identidade adaptada; reflete estado pós-correções Arnaldo + melhorias UX.
...
3. Na tela de seleção, clicar em **Vita-Sense Soluções Médicas Ltda.**
...
- Sprints 1-4 previamente validadas (`tutorialsprint4-3 V8.md` concluído — cadeia Vita-Sense S1→S4)
...
- **Produto-chave do conjunto:** Ventilador Pulmonar Dräger Savina 300 (SKU DRG-SVN300-BR)
- **Pré-requisito:** seed Sprint 5 executada com sucesso + cadeia Vita-Sense S1→S4 V8 concluída
