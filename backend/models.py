...
class User(Base):
    ...
    # Cascade só em dados de sessão/auth — banco faz SET NULL nas demais
    ...
    # Dados de negócio pertencem à empresa, não ao user — sem cascade
    produtos = relationship("Produto", back_populates="user")
    editais = relationship("Edital", back_populates="user")
    alertas = relationship("Alerta", back_populates="user")
    monitoramentos = relationship("Monitoramento", back_populates="user")
    notificacoes = relationship("Notificacao", back_populates="user")
    preferencias_notificacao = relationship("PreferenciasNotificacao", back_populates="user", uselist=False)
    documentos_gerados = relationship("Documento", back_populates="user")
    propostas = relationship("Proposta", back_populates="user")
    ...
    recursos = relationship("Recurso", back_populates="user")
    leads_crm = relationship("LeadCRM", back_populates="user")
    acoes_pos_perda = relationship("AcaoPosPerda", back_populates="user")
    auditoria_logs = relationship("AuditoriaLog", back_populates="user")
    aprendizado_feedback = relationship("AprendizadoFeedback", back_populates="user")
    parametro_score = relationship("ParametroScore", back_populates="user", uselist=False)
    dispensas = relationship("Dispensa", back_populates="user")
    estrategias = relationship("EstrategiaEdital", back_populates="user")
    lotes = relationship("Lote", back_populates="user")
