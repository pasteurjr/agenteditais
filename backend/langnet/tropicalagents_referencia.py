...
os.environ['OPENAI_API_KEY'] = "REDACTED_OPENAI_KEY_USE_ENV"
os.environ["OPENAI_MODEL_NAME"] = llm
os.environ["SERPER_API_KEY"] = "REDACTED_SERPER_KEY"
os.environ["SERPAPI_API_KEY"] = "REDACTED_SERPER_KEY"
os.environ["FIRECRAWL_API_KEY"] ="REDACTED_FIRECRAWL_KEY"
os.environ["PHI_API_KEY"] = "REDACTED_PHI_KEY"
...
production_efficiency_analisys_team = TeamClass(
    ...
    memory_system=MemoryFactoryClass().create_memory_system(
            ...
            api_key="REDACTED_OPENAI_KEY_USE_ENV",
