"""
Importa tutorial visual UC-F03 (gerir documentos da empresa).

Le:
  testes/datasets/UC-F03_visual.yaml
  testes/casos_de_teste/UC-F03_visual_fp.yaml
  testes/tutoriais_visual/UC-F03_fp.md

Insere/atualiza:
  - 1 linha em datasets (UC-F03, trilha=visual)
  - 8 linhas em passos_tutorial pra CT-F03-FP (passo_00 a passo_07)
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Upload de 3 documentos: Contrato Social (s/ validade), CRF FGTS (validade futura), Alvara (validade vencida)",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf03")
