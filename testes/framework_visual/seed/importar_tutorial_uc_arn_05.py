"""Importer auto-gerado para UC-ARN-05 (Sprint 10 — Correcoes Arnaldo)."""
...
def importar():
    print(f"=== importar_tutorial_uc_arn_05 ===")
    db = get_db()
    try:
        ...
        if not ct:
            ct = CasoDeTeste(
                ...
                descricao="Sidebar Configuracoes mantem labels curtos",
