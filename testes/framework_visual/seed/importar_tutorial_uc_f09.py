"""
Importa tutorial visual UC-F09 (reprocessar specs IA).
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Reprocessar especificacoes IA via chat (DeepSeek)",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf09")
