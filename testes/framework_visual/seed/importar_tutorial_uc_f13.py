"""
Importa tutorial visual UC-F13 V8 (gerir hierarquia Area/Classe/Subclasse).

Le:
  testes/datasets/UC-F13_visual.yaml
  testes/casos_de_teste/UC-F13_visual_fp.yaml
  testes/tutoriais_visual/UC-F13_fp.md

Insere/atualiza:
  - 1 linha em datasets (UC-F13, trilha=visual)
  - 12 linhas em passos_tutorial pra CT-F13-FP
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Cria 2 areas + 3 classes + 3 subclasses + visualiza arvore",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf13")
