"""
Importa tutorial visual UC-F15 (gerir documentos da empresa).

Le:
  testes/datasets/UC-F15_visual.yaml
  testes/casos_de_teste/UC-F15_visual_fp.yaml
  testes/tutoriais_visual/UC-F15_fp.md

Insere/atualiza:
  - 1 linha em datasets (UC-F15, trilha=visual)
  - 8 linhas em passos_tutorial pra CT-F15-FP (passo_00 a passo_07)
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Configura parametros comerciais aba Comercial (3 cards: Tempo Entrega, Mercado, Custos)",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf15")
