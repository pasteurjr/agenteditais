"""
Importa tutorial visual UC-F12 (reprocessar metadados captacao).
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Reprocessar metadados de captacao via IA",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf12")
