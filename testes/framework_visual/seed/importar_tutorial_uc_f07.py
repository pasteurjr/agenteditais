"""
Importa tutorial visual UC-F07 (cadastrar produto via IA).
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Cadastro de produto via IA a partir de manual tecnico em PDF (DeepSeek)",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf07")
