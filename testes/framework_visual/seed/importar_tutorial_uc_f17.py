"""
Importa tutorial visual UC-F17 (gerir documentos da empresa).

Le:
  testes/datasets/UC-F17_visual.yaml
  testes/casos_de_teste/UC-F17_visual_fp.yaml
  testes/tutoriais_visual/UC-F17_fp.md

Insere/atualiza:
  - 1 linha em datasets (UC-F17, trilha=visual)
  - 8 linhas em passos_tutorial pra CT-F17-FP (passo_00 a passo_07)
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Configura notificacoes (email/canais/frequencia) e preferencias (tema/idioma/fuso)",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf17")
