"""Importer auto-gerado para UC-ARN-18 (Sprint 10 — Correcoes Arnaldo)."""
...
def importar():
    print(f"=== importar_tutorial_uc_arn_18 ===")
    db = get_db()
    try:
        ...
        if not ct:
            ct = CasoDeTeste(
                ...
                descricao="Botao atualizar individual passa ID da certidao",
