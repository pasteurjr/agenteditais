"""
Importa tutorial visual UC-F14 (gerir documentos da empresa).

Le:
  testes/datasets/UC-F14_visual.yaml
  testes/casos_de_teste/UC-F14_visual_fp.yaml
  testes/tutoriais_visual/UC-F14_fp.md

Insere/atualiza:
  - 1 linha em datasets (UC-F14, trilha=visual)
  - 8 linhas em passos_tutorial pra CT-F14-FP (passo_00 a passo_07)
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Configura pesos e limiares de score (aba Score da ParametrizacoesPage)",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf14")
