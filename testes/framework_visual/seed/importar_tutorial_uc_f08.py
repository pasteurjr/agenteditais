"""
Importa tutorial visual UC-F08 (editar produto).
...
Insere/atualiza:
  ...
  - 4 linhas em passos_tutorial pra CT-F08-FP (passo_00 a passo_03)
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Editar produto criado pelo F07 — altera dados basicos e salva",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf08")
