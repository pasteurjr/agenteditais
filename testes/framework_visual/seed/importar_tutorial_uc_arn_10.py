"""Importer auto-gerado para UC-ARN-10 (Sprint 10 — Correcoes Arnaldo)."""
...
def importar():
    print(f"=== importar_tutorial_uc_arn_10 ===")
    db = get_db()
    try:
        ...
        if not ct:
            ct = CasoDeTeste(
                ...
                descricao="Cursor pointer global em elementos clicaveis",
