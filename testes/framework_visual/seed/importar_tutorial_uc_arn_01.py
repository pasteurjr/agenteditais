"""Importer auto-gerado para UC-ARN-01 (Sprint 10 — Correcoes Arnaldo)."""
...
def importar():
    print(f"=== importar_tutorial_uc_arn_01 ===")
    db = get_db()
    try:
        ...
        if not ct:
            ct = CasoDeTeste(
                ...
                descricao="Cadastro de empresa via upload IA + aceite humano",
