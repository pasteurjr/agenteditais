"""
Importa tutorial visual UC-F05 (gerir documentos da empresa).

Le:
  testes/datasets/UC-F05_visual.yaml
  testes/casos_de_teste/UC-F05_visual_fp.yaml
  testes/tutoriais_visual/UC-F05_fp.md

Insere/atualiza:
  - 1 linha em datasets (UC-F05, trilha=visual)
  - 8 linhas em passos_tutorial pra CT-F05-FP (passo_00 a passo_07)
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Cadastra 3 responsaveis (Representante Legal, Preposto, Responsavel Tecnico)",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf05")
