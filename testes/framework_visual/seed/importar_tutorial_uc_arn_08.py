"""Importer auto-gerado para UC-ARN-08 (Sprint 10 — Correcoes Arnaldo)."""
...
def importar():
    print(f"=== importar_tutorial_uc_arn_08 ===")
    db = get_db()
    try:
        ...
        if not ct:
            ct = CasoDeTeste(
                ...
                descricao="Sidebar persiste preferencia em localStorage",
