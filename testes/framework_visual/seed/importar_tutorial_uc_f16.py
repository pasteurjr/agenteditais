"""
Importa tutorial visual UC-F16 (gerir documentos da empresa).

Le:
  testes/datasets/UC-F16_visual.yaml
  testes/casos_de_teste/UC-F16_visual_fp.yaml
  testes/tutoriais_visual/UC-F16_fp.md

Insere/atualiza:
  - 1 linha em datasets (UC-F16, trilha=visual)
  - 8 linhas em passos_tutorial pra CT-F16-FP (passo_00 a passo_07)
    ...
    try:
        ...
        if not ct:
            ...
            ct = CasoDeTeste(
                ...
                ct_id=CT_ID,
                descricao="Configura palavras-chave e NCMs de busca aba Fontes de Busca",
                tipo="Positivo",
                categoria="Cenário",
        ...
        tut = carregar_tutorial(UC_ID, VARIACAO, "piloto-ucf16")
