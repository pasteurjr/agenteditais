...
dataset_ref: testes/datasets/UC-SC02_visual.yaml
caso_de_teste_ref: testes/casos_de_teste/UC-SC02_visual_fp.yaml
---

# UC-SC02 — Score de Qualidade dos Concorrentes (ConcorrenciaPage) (Fluxo Principal)
...
Score de qualidade dos concorrentes em ConcorrenciaPage.

```yaml
id: passo_00_navegar_conc
acao:
  sequencia:
    - tipo: evaluate
      valor_literal: |
    ...
    - tipo: wait_for
      ...
      timeout: 15000
validacao_ref: "testes/casos_de_teste/UC-SC02_visual_fp.yaml#passo_00_navegar_conc"
```
