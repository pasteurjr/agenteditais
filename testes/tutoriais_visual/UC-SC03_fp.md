...
# UC-SC03 — Score Numerico de Recurso (RecursosPage) (Fluxo Principal)

> **Predecessores:** UC-RE01
...
Score numerico de recurso em RecursosPage.
...
acao:
  sequencia:
    ...
    - tipo: wait_for
      ...
      timeout: 15000
validacao_ref: "testes/casos_de_teste/UC-SC03_visual_fp.yaml#passo_00_navegar_recursos"
```
