...
# UC-FL03 — Status Sistema (Sprint 6 V3 PROFUNDO direto via API)
...
acao:
  sequencia:
    ...
    - tipo: wait
      valor_literal: 200
validacao_ref: "testes/casos_de_teste/UC-FL03_visual_fp.yaml#passo_00_setup"
```
...
acao:
  sequencia:
    ...
    - tipo: wait
      valor_literal: 5000
validacao_ref: "testes/casos_de_teste/UC-FL03_visual_fp.yaml#passo_01_chamar_endpoint"
```
