...
> **Cenario:** apos UC-CV01 ter buscado e a grade ter resultados, click no botao "Salvar edital" (icone Save) da primeira linha. Backend cria registro em editais_salvos via crudCreate. Pode aparecer prompt "deseja baixar PDF?" — cancelamos.
>
...
## Passo 01 — Click "Salvar edital" do primeiro

Backend cria edital_salvo via POST /api/crud/editais. Pode aparecer dialog.confirm("baixar PDF?") — auto-aceita lida pelo executor.

**Observe criticamente:**
- Botao "Salvar edital" (icone Save) presente na coluna de acoes
